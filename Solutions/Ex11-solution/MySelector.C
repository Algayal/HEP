...
void MySelector::SlaveBegin(TTree * /*tree*/)
{
   ...
   TString option = GetOption();
   hPileup = new TH1F("hPileup", "Pileup Distribution;Number of Primary Vertices;Events", 60, 0, 60);
   GetOutputList()->Add(hPileup);
...
void MySelector::Terminate()
{
   ...
   // Draw the pileup histogram
   if (hPileup) {
      TCanvas* c1 = new TCanvas("c1", "Pileup", 800, 600);
      hPileup->Draw();
      c1->SaveAs("pileup_distribution.png"); // Optional: save to file
  }
